...
ARG PORT=8080
ENV PORT=$PORT
ARG CORSANYWHERE_WHITELIST=https://assets.urnowhere.com,https://metamorphosis3d.prod.urnowhere.com,https://metamorphosis3d.now.urnowhere.com,https://nwr-prod-env.appspot.com,https://godel.prod.urnowhere.com,https://nwr.urnowhere.com,https://now.urnowhere.com,https://3d.now.urnowhere.com,https://meta3d.dev.urnowhere.com,https://metamorphosis3d.qa.urnowhere.com,http://localhost,http://localhost:8081,https://localhost,https://localhost:8081
